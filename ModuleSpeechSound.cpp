...
{
  uint8_t param1_input  = readInput(this->param1_input, CONVERT_TO_6_BIT)+8;
  uint8_t param2_input  = readInput(this->param2_input, CONVERT_TO_6_BIT)+20;
  uint8_t param3_input  = readInput(this->param3_input, CONVERT_TO_7_BIT);
