...
uint8_t I2SExtended::begin(i2s_mode_t_extended mode, uint32_t sampleRate, uint8_t bitsPerSample)
{
  i2sMode = mode;
...
void I2SExtended::end()
{
  i2s_end();
}

void I2SExtended::write(int16_t leftData, int16_t rightData)
{
...
void I2SExtended::write(int16_t data)
{
  write(data,data);
}


void I2SExtended::write(int16_t *data, size_t samples)
{
...
uint32_t I2SExtended::availableForWrite()
{
