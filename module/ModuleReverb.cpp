...
uint16_t ModuleReverb::compute()
{
  ...
  RING_BUFFER[buffer_index_2] = ((audio * (4095 - (feedback >> 0))) >> 11) + ((RING_BUFFER[buffer_index_2] * (feedback >> 0)) >> 11);
  RING_BUFFER[buffer_index_3] = ((audio * (4095 - (feedback >> 1))) >> 11) + ((RING_BUFFER[buffer_index_3] * (feedback >> 1)) >> 11);
